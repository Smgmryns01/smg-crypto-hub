  ...
  return (
    <PageLayout>
      <div className="pt-24 pb-20 px-4"><div className="container-wide">
        ...
        <div className="mb-10">
          <div className="badge-blue mb-4 w-fit">Blockchain Basics</div>
          <h1 className="font-display text-display-md font-extrabold text-brand-white text-balance">
            Blockchain Basics <span className="gradient-text">Course Track</span>
          </h1>
          <p className="mt-4 text-brand-muted max-w-2xl">Master distributed ledgers, consensus mechanisms, nodes, blocks, and why blockchain changes trust.</p>
        </div>
        <div className="rounded-2xl border border-brand-gold/20 bg-brand-gold/5 p-8 mb-10 text-center">
          ...
          <p className="text-sm text-brand-muted mb-4">The full Blockchain Basics curriculum is structured and ready. Interactive lessons, quizzes, and certificates activate at Milestone 2 (v0.2.0).</p>
